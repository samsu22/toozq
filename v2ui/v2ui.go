...
func MigrateFromV2UI(dbPath string) error {
	...
	if err != nil {
		return common.NewError("init toozq database failed:", err)
	}
	...
	if err != nil {
		return common.NewError("get toozq user failed:", err)
	}
	...
	if err != nil {
		return common.NewError("add toozq inbounds failed:", err)
	}
